...
export default function TataLetakPublik({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex min-h-dvh flex-col pb-[64px] md:pb-0">
      <a
        href="#isi-utama"
        className="sr-only focus:not-sr-only focus:absolute focus:left-3 focus:top-3 focus:z-50 focus:rounded-[4px] focus:bg-paper focus:px-4 focus:py-3 focus:font-semibold"
      >
