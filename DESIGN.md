...
- **MOTION 2.** Gerak yang dipakai: pergantian foto di hero, perubahan state pada tombol, dan di kartu donasi bar yang terisi dari nol berikut angka rupiah yang berhitung naik. Keempatnya berjalan sekali saat halaman dibuka atau saat disentuh, tidak ada satu pun yang dipicu guliran, sesuai larangan BRIEF §12. Semuanya berhenti sendiri kalau perangkat meminta gerak minimal.
...
Lapisan gelap hero dipakai 0.94 di area teks, bukan 0.88 seperti sebelumnya. Angka 0.88 dulu dihitung untuk teks krem; kalimat pembuka yang emas di atas foto putih polos hanya berasio 4.07 di situ, di bawah ambang AA. Alasannya di `DECISIONS.md` D-92.
...
| `--gold` di atas lapisan hero 0.94 pada foto putih | 4.88 | PASS | PASS |
| `--cream` di atas lapisan hero 0.94 pada foto putih | 9.43 | PASS | PASS |
| `--ink-soft` di atas kartu paket terpilih (`teal/10`) | 5.76 | PASS | PASS |
| `--teal-ink` di atas kartu paket terpilih | 6.50 | PASS | PASS |
| Ikon `--teal` di atas kartu paket terpilih (non-teks) | 4.16 | (batas 3.0) | PASS |
...
- **Beranda**: hero berupa foto kegiatan pilihan pengurus yang berganti pelan dengan lapisan gelap di atasnya, judul pendek di bagian bawah foto, lalu kartu donasi yang sedikit menumpuk ke atas foto, lalu agenda terdekat sebagai carousel kartu, feed kabar, dan paragraf tentang kami.
- **Kartu progress**: label "Donasi berjalan" dan badge persentase di baris atas, rupiah sebagai angka utama dengan target sebagai baris kecil di bawahnya (urutan BRIEF §4), bar setebal 10px berujung membulat, lalu tiga kolom dipisah garis tipis: Jamaah dirangkul, Donasi masuk, Sisa hari. Tombol "Ikut donasi" penuh lebar di dalam kartu, dan "Rincian season" sebagai tautan teks di bawahnya supaya tidak ada dua tombol yang bersaing. Saat belum ada donasi, ketiga kolom tetap tampil berisi nol, tidak disembunyikan. Barnya terisi dari nol ke angka sebenarnya sekali saat halaman dibuka, dan di halaman publik angka rupiahnya ikut berhitung naik.
- **Kepala kartu donasi di beranda**: kalau season sudah punya judul, di atas angka rupiah ada foto header season selebar kartu dengan tinggi pasti 96px (140px dari `sm`), lalu label kecil "Donasi berjalan" dan judul seasonnya. Judulnya di bawah foto, bukan di atasnya: lapisan gelap yang cukup untuk meloloskan kontras pada foto paling terang justru menutupi hampir seluruh fotonya. Season tanpa foto menampilkan judulnya saja, tanpa kotak gelap pengganti. Selama judulnya masih kosong, seluruh kepala ini tidak dirender.
...
- **Donasi**: form satu kolom, empat kartu pilihan paket sebagai grid 2x2 di 360px (1, 5, 10, dan Berapapun), konversi hidup tepat di bawahnya. Tiap kartu memuat ikon, judul, rupiahnya, dan berapa jamaah yang terlayani. Kotak angka bebas baru muncul saat "Berapapun" dipilih.
...
- **Pengumuman**: carousel gambar mendatar 2:1 selebar kartu donasi di atasnya, tepat di bawahnya, berjalan sendiri tiap 5 detik dan berhenti begitu disentuh, di-hover, atau ada tautan di dalamnya yang menerima fokus keyboard. Tanpa teks sama sekali: semua pesan dititipkan ke gambarnya, jadi pengurus bebas menatanya. Titik penanda posisi di bawah. Kalau belum ada pengumuman, seluruh bagian ini tidak dirender.
- **Sorotan sosmed**: kartu embed Instagram dan TikTok setelah Laporan Kegiatan. Wadahnya berukuran pasti sejak awal (4:5 untuk Instagram, 9:16 untuk TikTok) dan skrip platformnya baru dimuat saat bagian ini mendekati layar, jadi beranda tidak ikut berat. Sebelum termuat, wadahnya sudah berupa tautan yang bisa dibuka.
- **Kuis dan polling**: satu kartu di bawah, sebelum Tentang. Pilihan jawaban berupa kotak setinggi 46px yang seluruh areanya bisa ditap, bukan lingkaran radio kecil. Hasil polling digambar sebagai batang mendatar satu warna, dengan angka dan persen ditulis di tiap batang, jadi tidak ada data yang hanya bisa didapat dengan menyentuh batangnya. Satu warna, bukan warna per pilihan: warna di sini menyatakan besaran, bukan identitas, dan mewarnai yang tertinggi berbeda berarti mewarnai peringkat.
- **Kartu kehadiran**: sepuluh kotak stempel dalam grid lima kolom. Yang terisi teal penuh, yang kosong bergaris. Angka di dalam kotak, bukan ikon, supaya jelas terbaca berapa yang sudah terkumpul.
- **Bar berganti**: menempel tepat di atas navigasi bawah, tinggi 38px, hanya di layar HP. Latar emas dengan tinta gelap, satu-satunya blok emas penuh di app, jadi mata langsung menemukannya tanpa perlu ukuran besar. Isinya dua kartu yang bergantian tiap 6,5 detik: ajakan mengikuti sosial media (ikon saja, sasaran tap 44 kali 38 piksel dari melebarkan tautannya, bukan meninggikan barnya) dan hitung mundur ke acara terdekat. Pergantiannya berupa geser mendatar 620ms dengan satu sapuan kilau gradasi, karena gerak menyamping menjelaskan bahwa ada kartu lain di bar yang sama sedangkan pergantian yang memudar terbaca seperti isi yang berubah sendiri. Perangkat yang meminta gerak minimal tetap mendapat kedua kartunya, hanya tanpa geser dan tanpa kilau. Kartu yang datanya kosong tidak dirender, dan kalau keduanya kosong barnya hilang sama sekali.
...
- Ikon pada kartu pilihan paket menggambarkan datanya sendiri: sebanyak paket, sebanyak sosok jamaah, disusun lima per baris. Bentuk padat tanpa stroke tipis. Empat lambang berbeda untuk empat pilihan justru akan jadi deretan ikon seragam yang dilarang itu, dan tidak satu pun benar-benar menambah arti.
